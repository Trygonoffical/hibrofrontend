...
export default function CartArea() {
    ...
    const cartItems = [
        { id: 1, name: 'Rodent Trap Box', price: 1000, oldPrice: 2000, rating: 5, img: '/Product/1.webp', qnt: 1 },
        { id: 2, name: 'Rodent Trap Box 2', price: 1000, oldPrice: 2000, rating: 5, img: '/Product/1.webp' ,qnt: 3  },
    ]
  ...
  return (
    <>
        ...
        <button className="group flex items-center p-2"  onClick={()=>showCartSidebarStatus()}>
            {/* <ShoppingCartIcon
                className="h-6 w-6 flex-shrink-0 text-gray-100 group-hover:text-gray-400"
                aria-hidden="true"
            />
            <span className="ml-1 -mt-4 text-sm font-medium text-gray-200 group-hover:text-gray-400">{0}</span>
            <span className="sr-only">items in cart, view bag</span> */}

            <Image src='/Images/cart.png' alt='shoppingCart Icon' width={25} height={25} />
              <span className="absolute top-2 ml-5 bg-[#ffffff] text-black text-xs rounded-full w-5 h-5 flex items-center justify-center">
                0
              </span>
        </button>
